            ...
            <div style={{ textAlign: 'left', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <div>
                ...
                <p className="ag-entrance ag-delay-3" style={{ color: 'var(--text-muted)', fontSize: 'clamp(0.92rem, 2.4vw, 1.08rem)', marginBottom: '1.5rem', lineHeight: '1.65', maxWidth: '590px' }}>
                  Welcome to American Fitness Project—a 20,000 sq. ft. flagship training facility built for powerlifters, athletes, and fitness enthusiasts. Featuring Rogue Olympic Monster racks, calibrated Eleiko plates, Woodway cardio decks, 1-on-1 master coaching, and an organic fuel protein bar. Open 24/7/365 with encrypted mobile keycard access.
                </p>
                  ...
                  <div className="marquee-track">
                    {[
                      ...
                      <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: '#ffffff', border: '1px solid var(--border-glass)', padding: '0.45rem 0.85rem', borderRadius: 'var(--radius-full)', boxShadow: '0 2px 8px rgba(15,23,42,0.03)', whiteSpace: 'nowrap', fontSize: '0.82rem' }}>
                        <CheckCircle2 color={item.color} size={16} style={{ flexShrink: 0 }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '1.5rem' }}>
            {[
              ...
              },
              {
                ...
                desc: 'On-site nutrition hub crafting cold-pressed juices, organic whey/plant protein shakes, pre-workout energy shots, and macro-balanced gourmet meals to accelerate your workout results.',
      ...
      <section style={{ padding: '4rem 0', background: 'var(--gradient-primary)', textAlign: 'center' }}>
        <div className="container scroll-reveal reveal-scale">
          ...
          <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: 'clamp(0.95rem, 2.4vw, 1.15rem)', maxWidth: '650px', margin: '0 auto 1.5rem auto' }}>
            Join American Fitness Project today and gain immediate 24/7 access to our Rogue weight floor, Woodway cardio deck, 1-on-1 master coaching, and organic fuel smoothie bar.
          </p>
